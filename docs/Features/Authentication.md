...
Email:
[admin@minicrm.com](mailto:admin@minicrm.com)
...
3. Explain how to run database migration (if needed).
4. Explain how to seed the admin user.
5. Explain how to test authentication.
6. Wait for the next feature before generating anything else.
